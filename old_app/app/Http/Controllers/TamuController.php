...
class TamuController extends Controller
{
  ...
  //   	$data_tamu= \App\Tamu::whereDate('created_at','LIKE','%'.$request->filter.'%')->paginate();
  ...
  //       else{
  //   		$data_tamu= \App\Tamu::orderBy('created_at','desc')->paginate(10);
   
  //   	}


        $data_tamu= \App\Tamu::orderBy('created_at','desc')->get();
    ...
    public function update(Request $request)
    {
        ...
        $tamu=\App\Tamu::findorFail($request->tamuid);
