...
<div class="card">
            ...
            <div class="row">
          <div class="col-12">
             <form class="form-inline ml-auto" action="/jrekap" method="get" >
...
<!--                     <input name="tgl" type="date" class="form-control mr-sm-2"> 
                    ...
                    <button type="button" class=" btn btn-success btn-sm " data-toggle="modal" data-target="#rl">Rekap Laporan</button>
