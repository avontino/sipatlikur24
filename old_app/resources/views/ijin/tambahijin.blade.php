			...
			<div class="row">
				<div class="col-md-12">
						<div class="panel">
						  ...
						  <form action="/ijin/create" method="POST"> 
				        	{{csrf_field()}}
						  ...
						  <div class="form-group">
						    ...
						    <input name="jumlah" type="text" class="form-control" id="jumlah" aria-describedby="emailHelp" value='0'>
						  </div>
						  ...
						  <div class="form-group">
						    ...
						    <textarea name="ket" class="form-control" id="exampleFormControlTextarea1" rows="3" >Keterangan</textarea>
						  </div>
