...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('garjas.index') }}" class="form-inline">
            ...
            @if(in_array(Auth::user()->role, ['pembina', 'admin']))
            <button type="button" class="btn btn-warning mr-2" data-toggle="modal" data-target="#syncModal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        @else
                        <strong>Petunjuk untuk {{ Auth::user()->role == 'admin' ? 'Admin' : 'Pembina' }}:</strong> Klik pada kolom nilai untuk mengedit. Data latihan siswa ditampilkan sebagai referensi.
                        @endif
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <td class="text-center">
                                        @if(in_array(Auth::user()->role, ['pembina', 'admin']) || (Auth::user()->role == 'siswa' && $item->nis == Auth::user()->username))
                                        <div class="btn-group">
