...
<div class="card">
            ...
            <div class="row">
          <div class="col-12">
             <form class="form-inline ml-auto" method="GET" action="/jurnalbaru">
            ...
            @if($data_jadwal->isEmpty())
              ...
              <table id="example3" class="table table-bordered table-striped">
                ...
                @foreach($data_jadwal as $jadwal)
                  ...
                  data-toggle="modal" data-target="#editjadwal">Tambah Jurnal</button>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
...
<div class="card">
          ...
          <div class="col-12">
             <form class="form-inline ml-auto" method="GET" action="/jurnalbaru">
                    ...
                    <button type="button" class=" mr-sm-4 btn btn-primary btn-sm " data-toggle="modal" data-target="#tambahabsen">Tambah Absensi</button>
        ...
        <h5 class="modal-title" id="exampleModalLabel">Tambah Absensi</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="form-group">
                ...
                <input name="kelas" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{auth()->user()->name}}" readonly>
              </div>
