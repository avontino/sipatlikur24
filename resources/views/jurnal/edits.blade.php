          ...
          <div class="panel">     
                ...
                @if($data_jurnal->isEmpty())
                   ...
                   <!-- <form class="form-inline" method="GET" action="/edits"> -->
                    <!-- <button type="button" class="btn btn-primary float-end mr-sm-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Jurnal</button> -->
...
<!--                    <input name="filter" class="form-control mr-sm-2" type="date" >
      ...
      <!--                <select name="cari" class="form-control mr-sm-2" >
                ...
                @endforeach                 
                  ...
                  data-bs-toggle="modal" data-bs-target="#editjurnal">Edit</button>
