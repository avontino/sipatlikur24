                                 ...
                                 <td>
                                     <div class="d-flex gap-1">
                                         @if($poin_pelanggaran >= 50 && $poin_pelanggaran < 75)
                                             <a href="/kasus/{{ $siswa->id }}/cetak-sp/1" target="_blank" class="btn btn-warning btn-sm text-white">
                                                 <i class="fas fa-print me-1"></i> Cetak SP 1
                                             </a>
                                         @elseif($poin_pelanggaran >= 75 && $poin_pelanggaran < 100)
                                             <a href="/kasus/{{ $siswa->id }}/cetak-sp/1" target="_blank" class="btn btn-warning btn-sm text-white me-1">
                                                 SP 1
                                             </a>
                                             <a href="/kasus/{{ $siswa->id }}/cetak-sp/2" target="_blank" class="btn btn-danger btn-sm">
                                         ...
                                         @elseif($poin_pelanggaran >= 100)
                                             ...
                                             <a href="/kasus/{{ $siswa->id }}/cetak-sp/2" target="_blank" class="btn btn-danger btn-sm me-1">
                                                 SP 2
                                             </a>
                                             <a href="/kasus/{{ $siswa->id }}/cetak-sp/3" target="_blank" class="btn bg-dark text-white btn-sm">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="kategori_poin_id" id="modal_kategori_poin_id" class="form-select" required>
                            ...
                            @foreach($kategori_poin as $kp)
                                <option value="{{ $kp->id }}">{{ $kp->nama }} ({{ ucfirst($kp->jenis) }} - {{ $kp->poin }} Poin)</option>
                            @endforeach
                        </select>
                    </div>
