...
class SuratController extends Controller
{
  ...
  //   	$data_surat= \App\Models\Surat::whereDate('tglmasuk','LIKE','%'.$request->filter.'%')->paginate();

  //       }  elseif($request->filled('cari')){ 

  //            $data_surat= \App\Models\Surat::
  ...
  //       else{
  //   		$data_surat= \App\Models\Surat::orderBy('created_at','desc')->paginate(10);
   
  //   	}


        $data_surat= \App\Models\Surat::orderBy('created_at','desc')->get();
    ...
    {	
    	\App\Models\Surat::create($request->all());
    ...
    {   
        $surat=\App\Models\Surat::where('id','LIKE',$id)->first();
    ...
    public function update(Request $request)
    {
        ...
        $surat=\App\Models\Surat::findorFail($request->srtid);
