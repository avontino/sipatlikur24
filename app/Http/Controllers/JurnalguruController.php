...
class JurnalguruController extends Controller
{
    ...
    {   
        ...
        $query = \App\Models\Jurnal::where('guru_id', auth()->user()->id);
        ...
        $data_jurnal = $query->orderBy('created_at', 'desc')->get();
    ...
    public function export(Request $request) 
    {
        ...
        return Excel::download(new JurnalguruExport($startDate, $endDate), 'Jurnalguru.xlsx');
    }
...
$jurnal=\App\Models\Jurnal::findorFail($request->jurnalid);
